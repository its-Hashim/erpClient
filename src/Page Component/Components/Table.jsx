      ...
      <div className="container-fluid">
        ...
        <div className="card-footer d-flex justify-content-between align-items-center">
          ...
          <div className="form-inline">
            ...
            disabled={(props.pageNo === 0)? true :false} onClick={(e)=>{props.dispatch({type:'DECREMENT_PAGENO'})}}>Prev</button>
            <span style={{margin:"20px"}}>Showing {Number(props.pageNo)+1} of {props.noOfPages}</span>
            <button className='btn btn-outline-dark font-weight-bold '
            disabled={(props.pageNo < props.noOfPages-1)?false:true} onClick={()=>{props.dispatch({type:'INCREMENT_PAGENO'})}}>Next</button>  
            ...
            <button className='btn btn-outline-dark font-weight-bold '
            type='submit' onSubmit={(e)=>{props.dispatch({type:'UPDATE_PAGENO', value:goToValue})}}>Go</button>
          </div>
          <div >
